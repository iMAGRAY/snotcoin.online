...
import { Ball, GAME_CONSTANTS, BALL_LEVELS, EXPLOSIVE_BALL, BULL_BALL } from '../types/fusion-game';
        ...
        for (let j = i + 1; j < updatedBalls.length; j++) {
          ...
          if (distance < minDistance) {
            if (ball1.isExplosive || ball2.isExplosive) {
              ...
              const { resolvedBall1, resolvedBall2, mergedBall, scoreIncrease, snotReward } = resolveCollision(ball1, ball2, nextBallId, inventory.Cap);
