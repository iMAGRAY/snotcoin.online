...
const QUESTS: Quest[] = [
  ...
  },
  {
    ...
    description: 'Spend 100 SnotCoins on upgrades.',
    completed: false,
  ...
  {
    id: 'snot_millionaire',
    title: 'Snot Millionaire',
    description: 'Collect a total of 1000 SnotCoins.',
    completed: false,
    icon: ICONS.SNOTCOIN,
    points: 100,
    date: '10/15/24',
  ...
  },
  {
    id: 'snot_investor',
    title: 'Snot Investor',
    description: 'Invest 500 SnotCoins in upgrades.',
    completed: false,
    icon: ICONS.SNOTCOIN,
    points: 70,
    date: '10/15/24',
