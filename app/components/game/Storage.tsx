...
const RewardDisplay: React.FC<{ amount: number | null; maxAmount: number; setRewardAmount: (amount: number | null) => void }> = 
  ...
  return (
    <div className="h-full w-full relative overflow-hidden">
      <div 
        ...
        style={{
          backgroundImage: "url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/BackGroundStorage-D4ROHHue4K4RiEgXWuyNdtA0DW2bye.webp')",
