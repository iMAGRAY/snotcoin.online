  ...
  return (
    <>
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Left%20Wall-xQQu8Lo6ZZOGThWBIUXSF81gzBvfx9.webp')",
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Right%20Wall-RApvf9XyobJ5u7wl6tQWfXriqU8FtV.webp')",
          backgroundSize: '100% 100%',
          backgroundRepeat: 'no-repeat',
          width: `${GAME_CONSTANTS.WALL_WIDTH * scaleFactor}px`,
          right: 0
