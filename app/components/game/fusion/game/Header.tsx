...
const Header: React.FC<HeaderProps> = ({ score, snot, isPaused, isGameOver, togglePause }) => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Header-leT3WNEtgbLAz4Bn1x4G5aDS3JdXyS.webp')",
    ...
    >
      ...
      >
        {isPaused ? <Play size={24} color="white" className="ml-1" /> : <Pause size={24} color="white" />}
      </button>
