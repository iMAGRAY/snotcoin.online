        ...
        {options.map((option) => (
          <motion.button
            ...
            className={`
              ...
              ${option.subText === 'Safe' ? 'from-blue-400 to-blue-600 border-blue-300 hover:from-blue-500 hover:to-blue-700' :
                option.subText === 'Occasional' ? 'from-green-400 to-green-600 border-green-300 hover:from-green-500 hover:to-green-700' :
                option.subText === 'Seldom' ? 'from-yellow-400 to-yellow-600 border-yellow-300 hover:from-yellow-500 hover:to-yellow-700' :
